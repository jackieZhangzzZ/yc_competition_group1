...
public class AppTest extends TestCase {
	...
	@Autowired
	private MapManageServiceImpl mapManagerServiceImpl;
	@Autowired 
	...
	@Test
	public void testSearchMapBike() {
		Bike bike = new Bike();
		List<Bike> list= mapManagerServiceImpl.searchBike(bike);
		List<Object> list2 = jsonutils.getList(list);
		System.out.println("新的list"+list2.toString());
